...
class Api:
    ...
    def extras_batch_images_api(self, req: models.ExtrasBatchImagesRequest):
        ...
        with self.queue_lock:
            result = postprocessing.run_extras(extras_mode=1, image_folder=image_folder, image="", input_dir="", output_dir="", save_output=False, pixelization=req.pixelization, pixelization_value=req.pixelization_value, pixelization_keep_res=req.pixelization_keep_res, **reqDict)
